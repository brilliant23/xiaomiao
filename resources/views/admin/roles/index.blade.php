                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form name="myForm" id="form1" novalidate>
                            ...
                            <div class="form-group">
                                <label for="role-permission" class="control-label">权限:</label>
                                <select chosen class="form-control" multiple
                                        data-placeholder-text-single="'选择权限'"
                                        no-results-text="'没有找到'" ng-model="role.permission"
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            formatter: function (value, row, index) {
                                var perms = '';
                                for ( x in row.perms) {
                                    perms += '<span class="label label-default">'+ row.perms[x].name +'</span> ';
                                }
                                return perms;
                            }
                        }, {
